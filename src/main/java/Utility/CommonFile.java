...
public static WebDriver driver;
	...
	{
		FileInputStream file=new FileInputStream("Invoice _TestData\\IFF_INVOICE_TEST_DATA.xlsx");
	...
	public static void captureScreenshotFaildTC(WebDriver driver, String nameOfMethod) throws Throwable
	{
		...
		File destination=new File("IFFInvoice_Project\\FailedScreenshot\\ "+ nameOfMethod +","+date+".png");
	...
	{
		FileInputStream fileF=new FileInputStream("Invoice _TestData\\IFF_INVOICE_TEST_DATA.xlsx");
